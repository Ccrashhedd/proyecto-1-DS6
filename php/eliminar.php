...
<body>
    ...
    <form>
        ...
        <!-- Nueva sección para eliminar empleado -->
        <div class="section">
            <h2>¿Desea eliminar empleado?</h2>
            <div class="submit-buttons">
                <button type="button" class="btn-primary" onclick="eliminarEmpleado()">Eliminar</button>
    ...
    <script>
        function eliminarEmpleado() {
            if (confirm("¿Está seguro de que desea eliminar este empleado?")) {
                ...
                // Redirigir o realizar otra acción después de eliminar
