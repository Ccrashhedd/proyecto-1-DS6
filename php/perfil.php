...
<body>
  <button class="logout-button" onclick="window.location.href='inic_sesion.html'">Cerrar Sesión</button>
  ...
  <script>
    ...
    async function cargarDatosEmpleado() {
      // Simulación de una respuesta del servidor (esto será reemplazado por la solicitud real)
      ...
      // Simula un retraso como si estuviera esperando la respuesta del servidor
      await new Promise(resolve => setTimeout(resolve, 1000));
  
      // Cargar los datos en el DOM
